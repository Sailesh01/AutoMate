...
public class DbHandler_power extends SQLiteOpenHelper{
        public static final String DATABASE_NAME="time6.db";
        public static final String TABLE_NAME="time_table6";
        public static final String COL_1="ID";
        public static final String COL_2="TIME";

        public DbHandler_power(Context context) {
