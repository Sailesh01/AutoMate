...
public class DbHandler_call extends SQLiteOpenHelper {
    public static final String DATABASE_NAME="time5.db";
    public static final String TABLE_NAME="time_table5";
    public static final String COL_1="ID";
    public static final String COL_2="TIME";

    public DbHandler_call(@Nullable Context context) {
