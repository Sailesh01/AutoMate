...
public class DbHandler_message extends SQLiteOpenHelper {
    public static final String DATABSE_NAME="time2.db";
    public static final String TABLE_NAME="time_table2";
    public static final String COL_1="ID";
    public static final String COL_2="TIME";

    public DbHandler_message(Context context) {
