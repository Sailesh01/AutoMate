...
public class DbHandler_silent extends SQLiteOpenHelper {
    public static final String DATABASE_NAME="time4.db";
    public static final String TABLE_NAME="time_table4";
    public static final String COL_1="ID";
    public static final String COL_2="TIME";

    public DbHandler_silent(Context context) {
