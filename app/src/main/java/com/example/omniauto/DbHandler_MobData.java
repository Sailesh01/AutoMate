...
public class DbHandler_MobData extends SQLiteOpenHelper {
    public static final String DATABASE_NAME="time7.db";
    public static final String TABLE_NAME="time_table7";
    public static final String COL_1="ID";
    public static final String COL_2="TIME";
    public DbHandler_MobData(Context context) {
